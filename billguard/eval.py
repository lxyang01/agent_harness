...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Run deterministic BillGuard evaluations")
    parser.add_argument("--dataset", default=str(project_root / "evals" / "billguard_cases.jsonl"))
